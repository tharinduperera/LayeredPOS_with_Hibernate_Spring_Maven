...
public class PlaceOrderFormController {
    ...
    private OrderBO orderBO = AppInitializer.getApplicationContex().getBean(OrderBO.class);
    private CustomerBO customerBO = AppInitializer.getApplicationContex().getBean(CustomerBO.class);
    private ItemBO itemBO = AppInitializer.getApplicationContex().getBean(ItemBO.class);
